...
{
  Generated from OpenSSL 4.0.2 Header File engine.h - Wed 16 Sep 15:08:15 BST 2026
}
...
const
  ...
  (*# define  ENGINE_FUNC(ret_type,name,args,default_val) OSSL_DEPRECATED_MESSAGE(#name ENGINE_INFO_MSG) static ossl_inline ret_type 
name args { return default_val; }*)
  (*# define  ENGINE_FUNC_NOARGS(ret_type,name,default_val) OSSL_DEPRECATED_MESSAGE(#name ENGINE_INFO_MSG) static ossl_inline ret_type 
name(void) { return default_val; }*)
  (*# define  ENGINE_VOID_FUNC(name,args) OSSL_DEPRECATED_MESSAGE(#name ENGINE_INFO_MSG) static ossl_inline void name args { }*)
  (*# define  ENGINE_VOID_FUNC_NOARGS(name) OSSL_DEPRECATED_MESSAGE(#name ENGINE_INFO_MSG) static ossl_inline void name(void) { }*)
  {$else}
