...
{
  Generated from OpenSSL 4.0.2 Header File bn.h - Wed 16 Sep 15:07:30 BST 2026
}
...
var
  ...
  * return 1 if a < 0 and 0 otherwise
  ...
  function BN_mod(rem:PBIGNUM; a:PBIGNUM; m:PBIGNUM; ctx:PBN_CTX): TOpenSSL_C_INT; inline;
  {$ifdef OPENSSL_STATIC_LINK_MODEL}
  function BN_nnmod(r: PBIGNUM; a: PBIGNUM; m: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl; external CLibCrypto name 'BN_nnmod';
  ...
  {Do not call Function LoadDeclarations. Internal use only}
  function Load_BN_nnmod(r: PBIGNUM; a: PBIGNUM; m: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl;
...
var
  BN_nnmod: function(r: PBIGNUM; a: PBIGNUM; m: PBIGNUM; ctx: PBN_CTX): TOpenSSL_C_INT; cdecl = Load_BN_nnmod;
...
function BN_mod(rem:PBIGNUM; a:PBIGNUM; m:PBIGNUM; ctx:PBN_CTX): TOpenSSL_C_INT;
begin
  Result := TOpenSSL_C_INT(BN_div(nil,rem,a,m,ctx));
end;
{$ifndef  OPENSSL_NO_EC2M}
